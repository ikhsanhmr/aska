...
<nav class="page-breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Inventory (Access Point)</li>
    </ol>
</nav>
                        ...
                        <tbody>
                            @foreach ($datas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('access-point.edit', ['access_point' => $data]) }}" class="btn btn-sm btn-primary btn-icon">
                                            <i data-feather="edit"></i>
                                        </a>
                                        <form action="{{ route('access-point.destroy', ['access_point'=> $data]) }}" style='display:inline;'  method="POST"  class="me-2" style="cursor:pointer;">
                                            @method('DELETE')
                                            @csrf
