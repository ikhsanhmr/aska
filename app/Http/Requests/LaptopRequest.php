...
class LaptopRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'barcode' => 'string',
            'vendor' => 'string',
            'bast' => 'mimes:pdf,doc,docx|max:2048',
            'bastp' => 'mimes:pdf,doc,docx|max:2048',
            'data_kontrak' => 'mimes:pdf,doc,docx|max:2048',
            'form_permintaan' => 'mimes:pdf,doc,docx|max:2048',
            'foto' => 'mimes:pdf,doc,docx,jpg,png,jpeg,webp|max:2048',
        ];
    }
